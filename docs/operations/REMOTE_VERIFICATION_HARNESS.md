...
See also: [AUTOMATION_ENGINE.md](../reference/AUTOMATION_ENGINE.md),
[BACKEND_RUNTIME.md](../reference/BACKEND_RUNTIME.md),
[VERIFICATION_AND_ACCEPTANCE.md](VERIFICATION_AND_ACCEPTANCE.md) (the acceptance
suites this harness runs), and the [Core Loop](../architecture/02_CORE_LOOP.md) it
proves end to end.
